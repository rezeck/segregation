...
max_it = 10000
x = (range(1, max_it+1))
filenames = [("exp_150_5_cluster_no_noise.npy", "150 robots (5 types)", "b"), ("exp_150_10_cluster_no_noise.npy", "150 robots (10 types)", "r"), ("exp_150_15_cluster_no_noise.npy", "150 robots (15 types)", "g")]

for filename in filenames:
	print "Loading Experiments", filename[0]
	experiments = np.matrix(np.load(filename[0]))/10.0
...
plt.legend()
plt.savefig('cluster_no_noise.png')
plt.show()

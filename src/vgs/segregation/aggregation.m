function data = aggregation(ROBOTS, GROUPS, ITERATIONS, expID, MULTIPLIER)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
q_init = WORLD * rand(ROBOTS, 2); % position.
q = q_init;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    
j = 1;
for it = 1:(MULTIPLIER*ITERATIONS)
...
if metric ~= 0
    name = ['exp', int2str(expID), 'r', int2str(ROBOTS), 'g', int2str(GROUPS), '.mat'];
    save(name, 'q_init');
end
...
filename = "exp_150_5_radial_1_noise.npy"
...
plt.semilogx(x, mean, 'r-', linewidth=1)
plt.semilogx(x, upper_bound, 'r--', linewidth=0.2)
plt.semilogx(x, lower_bound, 'r--', linewidth=0.2)
plt.ylim( 0 ) 
plt.xlim( 0 ) 
